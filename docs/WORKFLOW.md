...
1. แต่ละคนกรอกชื่อผู้ใช้ + รหัสผ่าน T&V **ของตนเอง** ในหน้าเว็บ (เก็บเฉพาะเซสชันของแท็บ)
2. รอป้ายสถานะเป็น **T&V: รหัสอยู่ในเซสชันนี้ ✓** — ปุ่มเริ่ม Automation จะปลดล็อก
3. ระบุผู้อนุมัติให้ตรงรายชื่อในพอร์ทัล
4. เลือกโหมด:
...
1. ล็อกอินพอร์ทัลด้วยบัญชีจากเซสชันของแท็บนั้น (ตรวจ `is_tv_logged_in`; ถ้าหมดอายุจะหยุดทันที)
2. เข้า Workflow 26
