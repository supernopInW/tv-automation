...
5. **ความปลอดภัยรหัสผ่าน (Security Protocol):**
   ...
   - `/api/run` รับ credential ครั้งเดียวตอนเริ่มกรอก ใช้ล็อกอินพอร์ทัลแล้วทิ้งจากหน่วยความจำ ไม่เขียนลง log
   - โหมดนี้รองรับเว็บออนไลน์ (Render) เพราะ Playwright ล็อกอินด้วยรหัสจากเซสชันของแท็บนั้นได้แบบ headless
